...
<head>
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
    ...
    <?php }elseif (is_single()) { ?>
        ...
        <link href="<?php bloginfo('template_directory'); ?>/assets/css/single.css?ver=1017" rel="stylesheet">
    <?php }else{ ?>
        <link href="<?php bloginfo('template_directory'); ?>/assets/css/pages.css?ver=1017" rel="stylesheet">
    <?php } ?>
  <?php wp_head(); ?>  
</head>
<body <?php body_class() ?>>
